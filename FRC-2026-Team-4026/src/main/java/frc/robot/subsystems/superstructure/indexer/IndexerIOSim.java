...
public class IndexerIOSim implements IndexerIO {
    ...
    public void updateInputs(IndexerIOInputs inputs) {
        ...
        inputs.indexerData = new IndexerIOData(true, true, rightGearbox.getInputVoltage(), leftGearbox.getInputVoltage(), leftGearbox.getCurrentDrawAmps(), rightGearbox.getCurrentDrawAmps(),0.0,0.0);
    }
