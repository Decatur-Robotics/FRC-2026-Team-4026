...
import frc.robot.subsystems.vision.template.VisionIO.PoseObservationType;
...
public class Vision extends SubsystemBase {
    ...
    public void periodic() {
        ...
        List<Double> allTagDistance = new LinkedList<>();
        ...
        for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
            ...
            List<Pose3d> robotPosesRejected = new LinkedList<>();
                    List<Double> tagDistance = new LinkedList<>();
            ...
            for (var observation : inputs[cameraIndex].poseObservations) {
                ...
                tagDistance.add(observation.averageTagDistance());
                                    Logger.recordOutput("Vision/robotDistance", observation.averageTagDistance());
            ...
            allTagDistance.addAll(tagDistance);
        }
