...
private enum AutoSide{
  ...
  public void configureSecondaryBindings() {
    Joystick joystick = new Joystick(1);
        ...
        triggerLeft.whileTrue(Commands.parallel(shooter.setVelocityWithSlider(), indexer.setVoltageCommand(8))).onFalse(Commands.parallel(shooter.setVoltageCommand(0), indexer.setVoltageCommand(0)));
